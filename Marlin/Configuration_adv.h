...
//#define AUTOTEMP
#if ENABLED(AUTOTEMP)
  #define AUTOTEMP_OLDWEIGHT    1.00
...
//#define EXTRUDER_RUNOUT_PREVENT
  ...
  #define EXTRUDER_RUNOUT_SECONDS (5*60)
  #define EXTRUDER_RUNOUT_SPEED 1000  // (mm/min)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        10000  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL      10000 // (mm/s^2) Lower acceleration may allow a faster feedrate.
